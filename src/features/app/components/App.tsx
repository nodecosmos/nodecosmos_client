            ...
            <div className={`background-2 h-100 ${THEME_STRING[themeIdx]}`}>
                ...
                <Box height={`calc(100% - ${HEADER_HEIGHT})`}>
                    <Routes>
                        ...
                        <Route path="/nodes/charybdis" element={<Navigate relative="route" to="/nodes/d916b9f2-b54d-4f90-944d-93f8ab908c2a/d916b9f2-b54d-4f90-944d-93f8ab908c2a?selectedObject=%3D%3D" />} />
                        <Route
                            path="/auth"
