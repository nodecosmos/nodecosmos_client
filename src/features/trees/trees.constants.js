...
export const MARGIN_TOP = NODE_BUTTON_HEIGHT / 2; // move children's edge down from current node's button y
export const EDGE_LENGTH = 26; // length of edge (link)
...
export const INITIAL_ANIMATION_DELAY = 75; // ms - move down siblings first than extend current node
