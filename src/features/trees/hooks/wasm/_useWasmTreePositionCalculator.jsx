 ...
 * @param rootId
 * @description
 * This is sample hook that is used to calculate the position of each node in the tree using the wasm tree library that
 * we have written in rust src/wasm/tree/src/lib.rs.
 *
 * Note that calculating the position of each node in the tree is not performance bottleneck, but it was good sample
